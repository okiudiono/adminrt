...
class Custom_model extends MY_Model
{
    ...
    {
        // if (!empty($this->session->userdata(ADMIN_FIKES_SESSION)["id"])) {
        //     $data['created_by'] =  $_SESSION[ADMIN_FIKES_SESSION]["id"] ?? null;
        // } else {
        //     $data['created_by'] =  $_SESSION[USER_FIKES_SESSION]["id"] ?? null;
        // }
        return $data;
    }
    ...
    {
        // if (!empty($this->session->userdata(ADMIN_FIKES_SESSION)["id"])) {
        //     $data['updated_by'] =  $_SESSION[ADMIN_FIKES_SESSION]["id"] ?? null;
        // } else {
        //     $data['updated_by'] =  $_SESSION[USER_FIKES_SESSION]["id"] ?? null;
        // }
        return $data;
    }
}
